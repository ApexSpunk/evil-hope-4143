...
import {addProductToCart, getCart, removeProductFromCart} from '../../Redux/cart/actions'
                    ...
                    <GridItem colSpan={2} >
                        <Grid templateColumns='repeat(2, 1fr)'>
                            <GridItem colSpan={2} mb='-4' boxSizing='border-box' rounded='none' border='1px solid #e2e8f0' p='4'>
                                ...
                                <Text fontSize='22px' mt='4' fontWeight='bold'>{singleProduct.title}</Text>
                            ...
                            <GridItem colSpan={1} mt='4' boxSizing='border-box' rounded='none' border='1px solid #e2e8f0' p='4'>
                                ...
                                <Flex>
                                    <Button mt='4' colorScheme='red' w='full' variant='solid' onClick={() => {
                                            if (!isAuthenticated) {
                                                toast({
                                        ...
                                        }} bg={product ? 'green.500' : 'red.500'} _hover={product ? { bg: 'green.600' } : { bg: 'red.600' }}>
                                            {product ? 'ADD AGAIN' : 'ADD TO CART'}
                                        </Button>
                                    {
                                        product ? <Button mt='4' ml='4' colorScheme='red' w='full' variant='solid' onClick={() => {
                                            ...
                                            product = null
                                        } }>REMOVE</Button> : <Button mt='4' ml='4' colorScheme='orange' w='full' variant='solid'>BUY NOW</Button>
                                    }
                                </Flex>
                            </GridItem>
                        </Grid>
