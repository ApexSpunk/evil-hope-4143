...
export const AUTH_GETOTP_REQUEST = 'auth/AUTH_GETOTP_REQUEST';
export const AUTH_GETOTP_SUCCESS = 'auth/AUTH_GETOTP_SUCCESS';
export const AUTH_GETOTP_FAILURE = 'auth/AUTH_GETOTP_FAILURE';
export const AUTH_GETOTP_RESET = 'auth/AUTH_GETOTP_RESET';